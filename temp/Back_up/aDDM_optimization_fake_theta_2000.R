...
aDDM.optimization.fake.theta.2000 = function(set.sizes,subjects){
  ...
  source('Scripts/aDDM_Simulation/aDDM_fake_2000.R')
  ...
  out[[1]]= foreach (i = ita,.combine='rbind') %dopar% aDDM_fake_2000(i)
