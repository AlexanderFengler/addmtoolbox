...
aDDM.optimization.fake.theta.3000 = function(set.sizes,subjects){
  ...
  source('Scripts/aDDM_Simulation/aDDM_fake_3000.R')
  ...
  drift.rates = 0.002 #c(0.001,0.0012,0.0014,0.0016,0.0018,0.002,0.0022,0.0024,0.0026,0.0028,0.003)
  ...
  thetas = c(0.3,0.325,0.35,0.375,0.4,0.425,0.45,0.475,0.5,0.525,0.55,0.575,0.6,0.625,0.65,0.675,0.7)
  ...
  out[[1]]= foreach (i = ita,.combine='rbind') %dopar% aDDM_fake_3000(i)
