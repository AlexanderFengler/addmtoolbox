...
// [[Rcpp::export]]
IntegerVector aevacc_6(int nr_reps,
                            int maxdur, 
                            float cur_sd, 
                            float theta,
  ...
  // Evid will be updated per ms ... it collects the current evidence for each item
   ...
   // We generate the attention-dependent evidence updates here to calculate only once and afterwards access
      ...
      NumericVector update_1(6);
      NumericVector update_2(6);
      NumericVector update_3(6);
      NumericVector update_4(6);
      NumericVector update_5(6);
      NumericVector update_6(6);
