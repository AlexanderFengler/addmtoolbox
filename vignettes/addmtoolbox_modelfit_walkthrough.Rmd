...
```{r, eval=FALSE}
 addm_fit_grid(conditions.dat = data.table(v1 = 0, v2 = 0, id = 0),
...
5. `log.file` is where the outcome list will be stored as a file. If you don't supply a name, it will still store it under **"defualtlog.txt"**, so you will not use your data. This file however, will be overwritten when you start a new grid search.
