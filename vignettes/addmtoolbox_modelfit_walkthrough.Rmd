...
Be sure to update the [addmtoolbox package](https://github.com/AlexanderFengler/addmtoolbox) regularly, since it is in a very early development stage and will improve rather rapidly over the next few month. Please provide [feedback here](https://github.com/AlexanderFengler/addmtoolbox/issues), such as **bugreports** or **suggestions** for useful additions to the functionality of the package.
